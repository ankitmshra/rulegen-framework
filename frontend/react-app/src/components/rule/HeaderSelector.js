      ...
      <div className="mb-4">
        <div className="flex justify-between mb-2">
          <div className="relative flex-1 max-w-xs">
            <input
              type="text"
              className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
