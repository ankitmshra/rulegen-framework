...
const EditUserModal = ({ user, onClose, onUserUpdated }) => {
  ...
  const [role, setRole] = useState(user.profile?.role || 'normal');
                ...
                <div className="sm:col-span-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="change-password" className="font-medium text-gray-700">
                        Change password
                      </label>
                      <p className="text-gray-500">Check this option to update the user's password.</p>
                    </div>
                  </div>
                </div>
